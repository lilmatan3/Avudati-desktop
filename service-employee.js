...
function detectTableType(text) {
  ...
  const categories = [
    ...
    {
      title: "💵 רכיבי שכר",
      keywords: ["שכריסוד", "נסיעות", "תמרותחופשה", "הבראה", "חג", "מחלה"]
    },
    {
      title: "🧍‍♂️ פרטים אישיים של העובד",
      keywords: ["זכויות", "זכויותמשפחתי", "זיכוי", "דרגה", "שנותותק", "תחילתעבודה", "קופג", "קהל"]
    },
    {
      title: "💳 ניכויי חובה",
      keywords: ["ביטוחלאומי", "בריאות", "פנסיה", "קופג", "ניכוי", "הרחבה", "קרן"]
    },
    {
      title: "💳 ניכויי רשות",
      keywords: [
        "ניכויירשות", "ניכוירשות", "ניכויי", "נכוי", "רשות", "ניכויי רשות", "ניכוי רשות",
        "ועד", "ניכויועד", "הלוואה", "קניית", "קנייתמזון", "מזון", "תרומה", "ביטוחים", "אחרים"
      ]
    },
    {
      title: "🧾 סיכום כללי / דוח כולל",
      keywords: [
        "שווהכסף", "שכרשווהכסף", "שכר שווה כסף",
        "קופגמעביד", "קופ\"ג", "קה\"ל", "קהלמעביד",
        "פטורסעיף47", "פטור", "פטור ס47", "סעיף47",
        "זיכוייחודי", "זיכוי אישי", "שווילמס", "שווי ברוטו",
        "מסהכנסה", "מס הכנסה", "השתלמות", "דוחכולל"
      ]
    },

    // קטגוריות כלליות קיימות
    {
      title: "🗓️ תקופת התשלום ומזהים כלליים",
      keywords: ["תלוששכר", "חודש", "שנתמס", "תאריךהפקת", "מספרתיקןיכויים", "תקופתשכר"]
    },
    {
      title: "📋 נתוני מס / עזר",
      keywords: ["יחידותמס", "סעיף", "נקודותזיכוי", "תושבישראל", "אשה", "שנתחישוב", "שנתגביה"]
    },
    {
      title: "⏱️ משרות ושעות עבודה",
      keywords: ["שעותעבודה", "היקףמשרה", "שעותלתשלום", "שעותבפועל", "שעותשבת", "שעותחוב", "שעותכוננות"]
    },
    {
      title: "📅 יתרות, הבראה והיעדרויות",
      keywords: ["חופשה", "מחלה", "הבראה", "יתרהחדשה", "יתרהקודמת", "ניצול", "זיכוי"]
    },
    {
      title: "💸 שכר נטו וסכום בבנק",
      keywords: ["שכרנטו", "סכוםלתשלום", "נטושלם", "סכוםלהעברה", "פרטיחשבוןבנק", "מספרחשבון"]
    },
    {
      title: "✅ סכומים מסכמים",
      keywords: ["סהכלתשלומים", "סהכניכויים", "ברוטו", "נטושולם", "ברוטולמס", "שווהברוטו"]
    }
  ];
